    ...
    <div className={style.globalContainer}>
      ...
      <nav className="flex justify-between ml-24">
        <div className=" backdrop-opacity-10 ">
          <a
            className="flex text-3xl font-sans font-medium items-center mx-2 hover:text-zinc-400 transition ease-in duration-200"
            href="/"
          >
            <img
              src="/images/logo1.png"
              alt="logo"
              className="w-8 h-8 my-6 mx-6"
            />
            Travelop
          </a>
        </div>
        <div className="mx-2">
          <ul className="flex flex-row my-7 mx-2">
            <Link to="/">
              <li className="mx-3.5 text-gray-600 hover:text-sky-700 transition ease-in duration-200 text-xl">
                Home
              </li>
            </Link>
            {/* <Link to={'#'}>
        ...
        <li className='mx-3.5 text-gray-600 hover:text-sky-700 transition ease-in duration-200 cursor-pointer text-xl'><a href='#'>Help</a></li>
            ...
            <Link to={"#"}>
              <li className="mx-3.5 text-gray-600 hover:text-sky-700 transition ease-in duration-200 cursor-pointer text-xl">
                <a href="#">About Us</a>
              </li>
            </Link>
          </ul>
